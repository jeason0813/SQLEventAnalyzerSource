...
namespace ICSharpCode.TextEditor.Actions
{
	...
	public class CaretUp : AbstractEditAction
	{
		public override void Execute(TextArea textArea)
		{
			...
			if (visualLine > 0)
			{
				Point pos = new Point(textArea.TextView.GetDrawingXPos(lineNr, position.X), textArea.TextView.DrawingPosition.Y + (visualLine - 1) * textArea.TextView.FontHeight - textArea.TextView.TextArea.VirtualTop.Y);
